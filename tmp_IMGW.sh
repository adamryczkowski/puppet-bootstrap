...
ip=10.0.19.151
reset; ./execute-script-remotely.sh prepare_GitLab_CI_runner.sh --extra-executable id_ed25519 --ssh-address adam@10.0.19.151 --user adam --step-debug  -- --ssh-identity id_ed25519 --gitlab-server https://git1.imgw.pl --gitlab-token ENMnScUBNMFDJqjQ8N9z --runner-name upiorny
