...
#reset; ./execute-script-remotely.sh prepare_spack.sh --lxc-name ci-runner --user adam -- --spack-mirror /media/adam-minipc/other/spack-mirror --pre-install boost --pre-install cmake
ip=10.51.192.15
reset; ./execute-script-remotely.sh prepare_spack.sh --ssh-address ${ip} --user adam -- --spack-mirror /media/adam-minipc/other/spack-mirror 
reset; ./execute-script-remotely.sh prepare_for_imgw.sh --lxc-name ci-runner --user adam --step-debug  -- --gcc 6
...
reset; ./execute-script-remotely.sh prepare_GitLab_CI_runner.sh --ssh-address adam@${ip} --step-debug -- --user adam --gitlab-server https://git1.imgw.pl --gitlab-token ENMnScUBNMFDJqjQ8N9z --runner-name adama-laptop
