...
reset; bash -x ./deploy_IMGW_CI.sh all1 --vpn-password AeXw13589123 --vpn-username aryczkowski --git-address git@git.imgw.ad:aryczkowski/propoze.git --git-branch CEfused --ssh-key-path /home/adam/tmp/puppet-bootstrap/id_ed25519 --host-repo-path /home/tmp/all1 --guest-repo-path /home/tmp/propoze --preinstall-spack boost --repo-path /media/adam-minipc/other/debs --spack_mirror /media/adam-minipc/other/spack-mirror 
